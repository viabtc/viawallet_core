...
class CoinAddressDerivationTests {
    ...
    private fun runDerivationChecks(coin: CoinType, address: String?) = when (coin) {
        ...
        AURORA, EVMOS, MOONRIVER, MOONBEAM, KAVAEVM, KLAYTN, METER, OKXCHAIN, COINEXSMARTCHAIN, BASE -> assertEquals("0x8f348F300873Fd5DA36950B2aC75a26584584feE", address)
        ...
        TERRA, TERRACLASSIC -> assertEquals("terra1rh402g98t7sly8trzqw5cyracntlep6qe3smug", address)
