...
class CoinAddressDerivationTests {
    ...
    private fun runDerivationChecks(coin: CoinType, address: String?) = when (coin) {
        ...
        AURORA, EVMOS, COINEXSMARTCHAIN -> assertEquals("0x8f348F300873Fd5DA36950B2aC75a26584584feE", address)
        ...
        SIMPLELEDGER -> assertEquals("simpleledger:qzqc9j4vmn96zrlaz3ytwzeepyj0lqkauch2rv8n8g", address)
    }
}
