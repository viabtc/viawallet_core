...
Transaction Signer::build(const Proto::SigningInput &input) {
    ...
    auto transaction = Transaction(
        ...
        /* storageLimit: */ load(input.storage_limit()),
        /* epochHeight: */ load(input.epoch_height()),
        /* epochHeight: */ load(input.chain_id()),
...
Data Signer::hash(const Transaction &transaction) const noexcept {
    ...
    append(encoded, RLP::encode(transaction.storageLimit));
    append(encoded, RLP::encode(transaction.epochHeight));
