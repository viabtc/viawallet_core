...
TWString *_Nonnull TWNervosAddressConvertToBech32mFullAddress(TWString *_Nonnull address) {
    auto str = reinterpret_cast<const std::string*>(address);
    return TWStringCreateWithUTF8Bytes(TW::Nervos::Address::convertToBech32mFullAddress(*str).c_str());
}
