...
public enum TW_Polkadot_Proto_Curve: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case ed25519 // = 0
  case sr25519 // = 1
  case UNRECOGNIZED(Int)
...
extension TW_Polkadot_Proto_Curve: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [TW_Polkadot_Proto_Curve] = [
    .ed25519,
    .sr25519,
  ]
}
...
public struct TW_Polkadot_Proto_SigningInput {
  ...
  public var curve: TW_Polkadot_Proto_Curve = .ed25519
...
extension TW_Polkadot_Proto_Curve: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ED25519"),
    1: .same(proto: "SR25519"),
  ]
}
...
extension TW_Polkadot_Proto_SigningInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 12: try { try decoder.decodeSingularEnumField(value: &self.curve) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.curve != .ed25519 {
      try visitor.visitSingularEnumField(value: self.curve, fieldNumber: 12)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
