...
bool b58_to_bin(void *bin, size_t *binszp, const char *b58, size_t b58sz)
{
	size_t binsz = *binszp;
...
int b58_check(const void *bin, size_t binsz, const char *base58str)
{
...
bool b58_enc(char *b58, size_t *b58sz, const void *data, size_t binsz)
{
...
bool b58check_enc(char *b58c, size_t *b58c_sz, uint8_t ver, const void *data, size_t datasz)
{
	...
	return b58_enc(b58c, b58c_sz, buf, 1 + datasz + 4);
}
